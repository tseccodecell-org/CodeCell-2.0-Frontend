          ...
          >
            <GlassCard hover={false} className="overflow-hidden">
              ...
              >
                ...
                <span
                  className={`shrink-0 flex items-center justify-center w-8 h-8 rounded-full border border-[#2E2E2E] bg-[#161616]/80 transition-all duration-300 ${
                    isOpen ? "rotate-180 border-[#4BE2C4]/40 text-[#E8FF00]" : "text-[#8A8880]"
                  }`}
                >
