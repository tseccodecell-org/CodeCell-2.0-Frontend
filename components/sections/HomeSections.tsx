...
const pastEvents = [
  ...
  },
  {
    ...
    type: "OFFLINE EVENT",
    date: "OCT 12, 2025",
    desc: "An exciting, high-energy offline fun event filled with mind-bending puzzles, team challenges, and interactive tech games.",
  ...
  },
  {
    ...
    type: "SEMINAR",
    date: "DEC 19, 2025",
    desc: "An exclusive seminar featuring industry experts sharing deep insights into modern tech stacks, best architectural practices, and career roadmaps.",
  ...
  },
  {
    ...
    type: "CONTEST",
    date: "RUNNING WEEKLY",
    desc: "Speed-running algorithmic, dynamic programming, and data structure problems to sharpen skills week after week.",
    image: "/sketchbook_binary_tree.png",
    stat: "1000+ Total Submissions",
  },
];

const teamMembers = [
  { name: "Laksh Shetty", role: "Technical Executive", handle: "@laksh_s", photo: "/team_tech.png", teams: ["tech"] },
  { name: "Wilbert Nadar", role: "Technical Executive", handle: "@wilbert_n", photo: "/team_tech.png", teams: ["tech"] },
  { name: "Darryl Mathias", role: "Technical Executive", handle: "@darryl_m", photo: "/team_tech.png", teams: ["tech"] },
  { name: "Krishna Jaiswal", role: "Technical Executive", handle: "@krishna_j", photo: "/team_tech.png", teams: ["tech"] },
  { name: "Shloka", role: "Technical Executive", handle: "@shloka", photo: "/team_tech.png", teams: ["tech"] },
  { name: "Shaurya", role: "Technical Executive", handle: "@shaurya", photo: "/team_event.png", teams: ["tech"] },
  { name: "Rucha Sinkar", role: "Technical Executive", handle: "@rucha_s", photo: "/team_event.png", teams: ["tech"] },
  { name: "Sanket", role: "Technical Executive", handle: "@sanket", photo: "/team_tech.png", teams: ["tech"] },
  { name: "Tanvir", role: "Marketing Executive", handle: "@tanvir", photo: "/team_tech.png", teams: ["marketing"] },
  { name: "Pranav Soneji", role: "Marketing Executive", handle: "@pranav_s", photo: "/team_event.png", teams: ["marketing"] },
  { name: "Aryan", role: "Marketing Executive", handle: "@aryan", photo: "/team_tech.png", teams: ["marketing"] },
  { name: "Omkar", role: "Marketing & Social Executive", handle: "@omkar", photo: "/team_tech.png", teams: ["marketing", "social"] },
  { name: "Soham", role: "Marketing & Social Executive", handle: "@soham", photo: "/team_tech.png", teams: ["marketing", "social"] },
  { name: "Shivam Thakur", role: "Technical & Marketing Executive", handle: "@shivam_t", photo: "/team_tech.png", teams: ["marketing", "tech"] },
  { name: "Yachna Sharma", role: "Design & Social Executive", handle: "@yachna_s", photo: "/team_pr.png", teams: ["design", "social"] },
  { name: "Piyusha", role: "Design & Social Executive", handle: "@piyusha", photo: "/team_pr.png", teams: ["design", "social"] }
];
...
type TeamTab = "all" | "tech" | "marketing" | "design" | "social";
    ...
    <div className="bg-[#0D0D0D]">
      ...
      <SectionWrap>
        ...
        <div className="flex flex-wrap gap-2 font-mono text-[10px] mb-10 -mt-6">
          {(["all", "tech", "marketing", "design", "social"] as const).map((tab) => (
            <button
              key={tab}
              type="button"
