...
const teamCrew = [
  { name: "Aryan Bhuimbar", role: "Marketing, Design & Overall Coordination", handle: "@aryan.b", photo: "/Scoms%20pics/Aryan.jpeg", team: "Scom", github: "https://github.com/Aryan-26", linkedin: "https://in.linkedin.com/in/aryanbhuimbar" },
  { name: "Darryl Mathias", role: "Tech (Backend, DevOps & Cloud)", handle: "@darryl.m", photo: "/Scoms%20pics/darryl.jpg", team: "Scom", github: " https://darrylmathias.tech", linkedin: "https://www.linkedin.com/in/darryl-mathias-020241317/" },
  ...
  { name: "Laksh Shetty", role: "Tech & Documentation", handle: "@laksh.s", photo: "/Scoms%20pics/Laksh.jpg", team: "Scom", github: "https://github.com/Laksh-Shetty", linkedin: "https://in.linkedin.com/in/laksh-shetty-4bb576307" },
  ...
  { name: "Piyusha Bhadane", role: "Design, Tech (Frontend) & Brochure", handle: "@piyusha.b", photo: "/Scoms%20pics/Piyusha.jpg", team: "Scom", github: "https://github.com/bhadanepiyusha", linkedin: "https://www.linkedin.com/in/piyusha-bhadane-47077b329/" },
  ...
  { name: "Shaurya Wajge", role: "Tech (Frontend, Backend & Integration)", handle: "@shaurya.w", photo: "/Scoms%20pics/shaurya.jpeg", team: "Scom", github: "https://github.com/shaurya-w", linkedin: "https://in.linkedin.com/in/shaurya-wajge" },
  { name: "Shivam Thakur", role: "Tech", handle: "@shivam.t", photo: "/Scoms%20pics/Shivam.jpg", team: "Scom", github: "https://github.com/codexllamma", linkedin: "https://www.linkedin.com/in/shivam-thakur-a404a033b/" },
  ...
  { name: "Shreya Awari", role: "Publicity Head", handle: "@shreya.a", photo: "/Scoms%20pics/Shreya.jpg", team: "Scom", github: "https://github.com/shreyaawari28", linkedin: "https://www.linkedin.com/in/shreya-awari-/" },
  { name: "Soham Keswani", role: "Marketing, Design ,Tech & Overall Coordination", handle: "@soham.k", photo: "/Scoms%20pics/Soham.jpg", team: "Scom", github: "https://github.com/sohamk273", linkedin: "https://www.linkedin.com/in/soham-keswani-b7b1a6355/" },
  { name: "Suhani Motwani", role: "Marketing, Overall Coordination & Tech", handle: "@suhani.m", photo: "/Scoms%20pics/Suhani.jpg", team: "Scom", github: "https://github.com/SuhaniMotwani", linkedin: "https://www.linkedin.com/in/suhani-motwani-502b7135a/" },
  { name: "Tanvir Singh Kohli", role: "Marketing, Design & Tech", handle: "@tanvir.s", photo: "/Scoms%20pics/Tanvir.jpeg", team: "Scom", github: "https://github.com/MrTSinghK", linkedin: "https://www.linkedin.com/in/tanvir-harpreet-singh-kohli-a45716219/" },
  { name: "Tejas Halvankar", role: "Marketing, Design & Tech", handle: "@tejas.h", photo: "/Scoms%20pics/Tejas.jpg", team: "Scom", github: "https://github.com/Tejas-H01", linkedin: "https://www.linkedin.com/in/tejashalvankar" },
  { name: "Wilbert Nadar", role: "Tech (Backend & Problem Setting)", handle: "@wilbert.n", photo: "/Scoms%20pics/Wilbert.jpg", team: "Scom", github: "https://github.com/wilbert0838n", linkedin: "https://www.linkedin.com/in/wilbert-nadar/" },
  { name: "Yachna Sharma", role: "Design & Brochure", handle: "@yachna.s", photo: "/Scoms%20pics/Yachna.jpg", team: "Scom", github: "https://github.com/yach26", linkedin: "https://www.linkedin.com/in/yachna-sharma-005063346" },
        ...
        {TABS.map((tab) => {
          ...
          return (
            <button
              ...
              style={
                isActive
                  ? { backgroundColor: `${tab.accent}1A`, borderColor: tab.accent, color: tab.accent }
                  : undefined
              }
              className={`${orbitron.className} relative px-3 sm:px-4 py-2 text-[10px] sm:text-xs uppercase tracking-wider transition-all duration-300 border rounded-sm whitespace-nowrap ${
                isActive ? "scale-105" : "border-[#333] text-[#888] hover:border-[#555] hover:text-[#ccc] hover:scale-[1.02]"
              }`}
            >
              {tab.label}
            </button>
          ...
          >
            {filteredTeam.map((member, idx) => (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.4, delay: Math.min(idx * 0.04, 0.3), ease: "easeOut" }}
                ...
                >
                  <div className="relative aspect-[4/5] w-full shrink-0 overflow-hidden bg-[#0a0a0a]">
                    <Image
                      ...
                      className={`object-cover grayscale group-hover/card:grayscale-0 transition-all duration-500 group-hover/card:scale-105 ${
                      ...
                      <div className="flex gap-2">
                        <a
                          ...
                          className={`flex items-center gap-1.5 font-mono text-[9px] px-3 py-1.5 rounded-sm bg-[#0D0D0D]/90 border border-[#2E2E2E] transition-colors z-20 ${
                            member.github ? "text-[#4BE2C4] hover:border-[#4BE2C4]" : "text-[#8A8880] opacity-50 cursor-default"
                          }`}
                        >
                        ...
                        <a
                          ...
                          className={`flex items-center gap-1.5 font-mono text-[9px] px-3 py-1.5 rounded-sm bg-[#0D0D0D]/90 border border-[#2E2E2E] transition-colors z-20 ${
                            member.linkedin ? "text-[#E8FF00] hover:border-[#E8FF00]" : "text-[#8A8880] opacity-50 cursor-default"
                          }`}
                        >
                  ...
                  <div className="p-4 border-t border-[#111111] flex-1 bg-[#050505] relative z-10">
                    <h4 className={`${orbitron.className} text-sm font-semibold text-[#F0EDE6] truncate`}>
                      {member.name}
                    </h4>
                    <p
                      className={`font-mono text-[9px] mt-1 truncate ${
                        activeTab === "Scom" ? "text-[#E8FF00]" : activeTab === "jcom" ? "text-[#4BE2C4]" : "text-[#B388FF]"
                      }`}
                    >
                      {member.role}
                    </p>
      ...
      <SectionWrap id="mission">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 md:gap-10 lg:gap-12 items-start">
          <BentoMotion className="lg:col-span-7">
            <span className={`${orbitron.className} text-label-tag text-[#E8FF00] block mb-4`}>
              // GUILD_MISSION
            </span>
            <h2 className={`${orbitron.className} text-h1-scale font-bold uppercase text-[#F0EDE6] tracking-tight leading-[1.05] mb-8`}>
              Engineers, Not Slideshows
            </h2>
            <div className="space-y-5 text-body-scale text-[#8A8880] leading-relaxed max-w-2xl">
              <p>
                TSEC CodeCell is the technical core of Thadomal Shahani Engineering College —
                closing the gap between the syllabus and how software actually gets built.
              </p>
              <p>
                Sandboxes, workshops, and TSEC Hacks — our flagship hackathon. Every line
                written here is a step toward real systems, real interfaces, real algorithms.
              </p>
            </div>
            <Link
              href="/dashboard"
              ...
              {values.map((val, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <h4 className={`${orbitron.className} text-sm md:text-base font-semibold text-[#F0EDE6] uppercase tracking-tight`}>
                        {val.title}
                      </h4>
